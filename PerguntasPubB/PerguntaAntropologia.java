...
public class PerguntaAntropologia extends javax.swing.JFrame {
    ...
    private void PerguntaHistoria() {

        PerguntaHistoria hist = new PerguntaHistoria();
        hist.setVisible(true);
    }

    public PerguntaAntropologia() {
        initComponents();
    ...
    private void btnPausarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPausarMouseReleased
        try {
            ...
            Logger.getLogger(PerguntaAntropologia.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerguntaAntropologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerguntaAntropologia().setVisible(true);
            }
        });
    }
        ...
        ActionListener acao = new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                ...
                case 1:
                    ...
                    JOptionPane.showMessageDialog(null,"Você tomou um ataque de 10s");
                  atualSegundo =30;
