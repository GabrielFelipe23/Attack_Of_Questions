 ...
 */
package br.com.Attack.PerguntasPubB;

import br.com.Attack.PerguntasPubA.Ataques;
...
public class PerguntaHistoria extends javax.swing.JFrame {
    ...
    private void TelaPerguntaIntercambio() {
        ...
        PerguntaIntercambio intc = new PerguntaIntercambio();
    ...
    private void initComponents() {
        ...
        Fundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Attack/icones/historia.png"))); // NOI18N
    ...
    private void btnPausarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPausarMouseReleased
        try {
            ...
            Logger.getLogger(PerguntaHistoria.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerguntaHistoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerguntaHistoria().setVisible(true);
            }
        });
    }
