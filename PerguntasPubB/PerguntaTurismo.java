...
import br.com.Attack.PerguntasPubA.*;
...
public class PerguntaTurismo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Fundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Attack/icones/turismo.png"))); // NOI18N
    ...
    private void btnPausarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPausarMouseReleased
        try {
            ...
            Logger.getLogger(PerguntaTurismo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerguntaTurismo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerguntaTurismo().setVisible(true);
            }
        });
    }
