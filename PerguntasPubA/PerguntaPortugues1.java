 ...
 * @author Alex
 */
public class PerguntaPortugues1 extends javax.swing.JFrame {
    public static int XP4 = 0;
    private Timer timer;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnChance, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 460, -1, -1));
        ...
        getContentPane().add(btnAtaques, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 450, -1, -1));
        ...
        getContentPane().add(btn10seg, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 460, -1, -1));

        Fundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Attack/icones/PergPort1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerguntaPortugues1().setVisible(true);
            }
        });
    }
...
private void iniciarContagem() {
        ActionListener acao = new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                ...
                if(atualSegundo==0){
                    timer.stop();
                    switch(JOptionPane.showConfirmDialog(null,"Que Pena, Você perdeu, Mas você pode usar sua chance!, deseja usa-lá?","Tudo Tem uma segunda chance",JOptionPane.YES_NO_OPTION)){
                case 0:
                    JOptionPane.showMessageDialog(null, "Clique no botão 'CHANCE', mas lembre-se, você só tem uma");
                    break;
                case 1:
                    TelaMenuPrincipal();
                      break;
